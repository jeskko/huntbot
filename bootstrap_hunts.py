...
def relay_to_sql(msg):
    return (msg['relay']['Key'],
       ...
       msg['relay']['currentHp'],
       msg['relay']['maxHp'],
       datetime.fromtimestamp(msg['lastSeen']/1000),
       datetime.fromtimestamp(msg['lastFound']/1000),
       datetime.fromtimestamp(msg['lastKilled']/1000),
       datetime.fromtimestamp(msg['lastUpdated']/1000),
       datetime.fromtimestamp(msg['lastUntouched']/1000),
       msg['relay']['actorId'],
       0,
       msg['relay']['coords']['x'],
       msg['relay']['coords']['y']
